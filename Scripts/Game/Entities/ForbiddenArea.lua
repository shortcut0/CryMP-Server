...
function ForbiddenArea.Server:OnEnterArea(entity, areaId)
    ForbiddenArea.SvOnEnterArea(self, entity, areaId)
end


----------------------------------------------------------------------------------------------------
function ForbiddenArea:SvOnEnterArea(entity, areaId)
...
----------------------------------------------------------------------------------------------------
function ForbiddenArea:SvOnLeaveArea(entity, areaId)
    if (entity.actor) then
        local inside=false;
        for i,v in ipairs(self.inside) do
            if (v==entity.id) then
...
function ForbiddenArea.Server:OnLeaveArea(entity, areaId)
    ForbiddenArea.SvOnLeaveArea(self, entity, areaId)
end
