...
----------------------------------------------------------------------------------------------------
--  History:
--  - 13:6:2006   12:12 : Created by M�rcio Martins
--
----------------------------------------------------------------------------------------------------
...
Factory.NetSetup={
    ...
    ClientMethods =	{
        ...
        ClVehicleBuilt          = { RELIABLE_ORDERED, NO_ATTACH, STRING, ENTITYID, ENTITYID, INT8, INT8 },
        ClVehicleQueued         = { RELIABLE_ORDERED, NO_ATTACH, STRING, },
        ClVehicleCancel         = { RELIABLE_ORDERED, NO_ATTACH, STRING, },
        ClSetBuyFlags           = { RELIABLE_ORDERED, NO_ATTACH, ENTITYID, INT16 };
    },
    ServerMethods = {
    },
    ServerProperties = {
