...
CreateLocalization("l_ui_teleportedUP", {
    english = "Teleported ( ${1}m ) Up"
})
...
CreateLocalization("l_ui_chat_cheatDetected", {
    english = "(${1}: Detected Using ${2} (${3}))"
})



CreateLocalization("l_ui_helpSendToConsole", {
    english = "${1} :: Open your Console for Info about this Command"
})
CreateLocalization("l_ui_helpSendToXConsole", {
    english = "(${1}: Sent Help for !${2} To Console)"
})
...
CreateLocalization("l_ui_xRemoved", {
    english = "(${1}: Removed)"
})
...
CreateLocalization("l_ui_clm_IllegalCVar", {
    english = "Illegal CVar ${red}${2}${gray} Detected on ${red}${1}${gray} (${orange}${3}$9)"
})
CreateLocalization("l_ui_clm_InvalidCVar", {
    english = "Client $4${1}$9 reported Modified CVar $4${2}"
})
CreateLocalization("l_ui_clm_hwidReceived", {
    english = "Received PC Info from ${red}${1}${gray} (${red}${2}${gray})"
})
...
CreateLocalization("l_ui_captureTheBuildingToEnter", {
    english = "Capture the ${1} to use this Vehicle"
})
...
CreateLocalization("l_ui_prestigeAwardedAll", {
    english = "All Players: Awarded ( ${1} ) Prestige"
})
...
CreateLocalization("l_ui_superMode", {
    english = "Superman"
})

CreateLocalization("l_ui_mapSetupLoaded", {
    english = "Loading Map Setup for ${red}${1}${gray} (${red}${2}${gray})"
})
CreateLocalization("l_ui_noMapSetupFound", {
    english = "No Map Setup found for Map ${red}${1}${gray} (${red}${2}${gray})"
})
CreateLocalization("l_ui_mapSetupIsDisabled", {
    english = "Map Setup for Map ${red}${1}${gray} (${red}${2}${gray}) is Disabled"
})
