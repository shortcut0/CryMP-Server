local LocaleList = {
    ["l_console_on_connection"] = {
        ...
        spanish = { regular = "${1} Nueva conecion en el Canal ${2}", extended = "${1} Nueva conecion en el Canal ${2} (${3})", },
        german = { regular = "${1} Neue Verbindung auf Kanal ${2}", extended = "${1} Neue Verbindung auf Kanal ${2} (${3})", },
        russian = { regular = "${1} Podklyuchaetsya na kanale ${2}", extended = "${1} Podklyuchaetsya na kanale ${2} (${3})", },
    },
    ...
    ["l_console_on_connected"] = {
        ...
        spanish = { regular = "${1} Conectar en el Canal ${2}", extended = "${1} Conectar en el Canal ${2} (${3})", },
        german = { regular = "${1} Verbunden auf Kanal ${2}", extended = "${1} Verbunden auf Kanal ${2} (${3})", },
        russian = { regular = "${1} Podklyuchen k kanalu ${2}", extended = "${1} Podklyuchen k kanalu ${2} (${3})", }
    },
    ...
    ["l_console_on_disconnected"] = {
        ...
        spanish = { regular = "${gray}${1}${gray} Desconectado del Canal ${2}", extended = "${gray}${1}${gray} Desconectado del Canal ${2} (${3})", },
        german = { regular = "${gray}${1}${gray} Verbindung Getrennt vom Kanal ${2}", extended = "${gray}${1}${gray} Verbindung Getrennt vom Kanal ${2} (${3})", },
